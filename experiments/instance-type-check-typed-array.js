...
(function() {
  ...
  function instanceIs(obj, typeInfo, typeInfoIndex) {
    ...
    return !!inheritanceTable && inheritanceTable[typeInfoIndex] === typeInfo;
  }

  // EventTarget
  var $EventTarget_TypeInfo = idCounter++;
  var $EventTarget_TypeInfoIndex = 0;
  var $EventTarget_InheritanceTable = new Uint16Array([$EventTarget_TypeInfo]);
  ...
  var $Node_InheritanceTable = new Uint16Array([$EventTarget_TypeInfo, $Node_TypeInfo]);
  ...
  var $Element_InheritanceTable = new Uint16Array([$EventTarget_TypeInfo, $Node_TypeInfo, $Element_TypeInfo]);
  ...
  var $HTMLElement_InheritanceTable = new Uint16Array([$EventTarget_TypeInfo, $Node_TypeInfo, $Element_TypeInfo, $HTMLElement_TypeInfo]);
  ...
  var $HTMLDivElement_InheritanceTable = new Uint16Array([$EventTarget_TypeInfo, $Node_TypeInfo, $Element_TypeInfo, $HTMLElement_TypeInfo, $HTMLDivElement_TypeInfo]);
  ...
  var $XMLHttpRequest_InheritanceTable = new Uint16Array([$EventTarget_TypeInfo, $XMLHttpRequest_TypeInfo]);
